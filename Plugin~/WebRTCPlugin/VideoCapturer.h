...
namespace WebRTC {
    ...
    public:
        ...
        const std::vector<cricket::VideoFormat>* GetSupportedFormats() const;
        ...
        bool StartCapturing(const cricket::VideoFormat& capture_format);
        ...
        virtual CaptureState Start(const cricket::VideoFormat& capture_format) = 0;
        ...
        const cricket::VideoFormat* GetCaptureFormat() const { return capture_format_.get(); }
        ...
        void ConstrainSupportedFormats(const cricket::VideoFormat& max_format);
    ...
    protected:
        ...
        void SetCaptureFormat(const cricket::VideoFormat* format) {
            capture_format_.reset(format ? new cricket::VideoFormat(*format) : NULL);
        }

        void SetSupportedFormats(const std::vector<cricket::VideoFormat>& formats);
    ...
    private:
        ...
        // details.
        int64_t GetFormatDistance(const cricket::VideoFormat& desired,
        ...
        bool ShouldFilterFormat(const cricket::VideoFormat& format) const;
        ...
        std::vector<cricket::VideoFormat> supported_formats_;
        std::unique_ptr<cricket::VideoFormat> max_format_;
        std::vector<cricket::VideoFormat> filtered_supported_formats_;
