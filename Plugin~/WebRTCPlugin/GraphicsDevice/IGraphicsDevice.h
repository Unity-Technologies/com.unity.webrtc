...
public:
    ...
    virtual ITexture2D* CreateStagingTextureV(uint32_t width, uint32_t height) { return NULL; }
    ...
    virtual rtc::scoped_refptr<webrtc::I420Buffer> ConvertRGBToI420(ITexture2D* tex) { return NULL; }
