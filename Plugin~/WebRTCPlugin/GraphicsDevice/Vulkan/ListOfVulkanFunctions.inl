...
DEVICE_VULKAN_FUNCTION(vkCmdEndRenderPass)
...
DEVICE_VULKAN_FUNCTION(vkQueuePresentKHR)
...
DEVICE_VULKAN_FUNCTION(vkAcquireNextImageKHR)
DEVICE_VULKAN_FUNCTION(vkCreateSemaphore)
DEVICE_VULKAN_FUNCTION(vkDestroySemaphore)
