...
#pragma warning restore 0612
    ...
    internal static class NativeMethods
    {
        ...
        [DllImport(WebRTC.Lib)]
        public static extern IntPtr CreateExternalTexture(int width, int height, GraphicsFormat format);
        [DllImport(WebRTC.Lib)]
        public static extern VideoFrameBuffer ExternalTextureVideoFrameBufferCreate(IntPtr texture);
        [DllImport(WebRTC.Lib)]
        [return: MarshalAs(UnmanagedType.U1)]
        public static extern bool VideoFrameBufferDelete(IntPtr buffer);
        [DllImport(WebRTC.Lib)]
        [return: MarshalAs(UnmanagedType.U1)]
        public static extern bool VideoFrameBufferReserve(IntPtr buffer);
        [DllImport(WebRTC.Lib)]
        public static extern VideoFrameBufferState VideoFrameBufferGetState(IntPtr buffer);
    }
