var UnityWebRTCDataChannel = {
  ...
  CreateDataChannel: function(peerPtr, labelPtr, optionsJsonPtr) {
    ...
    dataChannel.onerror = function (evt) {
      if (!uwcom_existsCheck(this.managePtr, "onerror", "dataChannel")) return;
      Module.dynCall_vi(uwevt_DCOnError, this.managePtr);
    };
  ...
  DataChannelRegisterOnMessage: function (contextPtr, dataChannelPtr, DataChannelNativeOnMessage) {
  ...
  DataChannelRegisterOnTextMessage: function (contextPtr, dataChannelPtr, DataChannelNativeOnTextMessage) {
  ...
  DataChannelRegisterOnError: function (contextPtr, dataChannelPtr, DataChannelNativeOnClose) {
    if (!uwcom_existsCheck(dataChannelPtr, 'DataChannelRegisterOnError', 'dataChannel')) return;
    uwevt_DCOnError = DataChannelNativeOnClose;
  },

  DataChannelRegisterOnOpen: function (contextPtr, dataChannelPtr, DataChannelNativeOnOpen) {
    if (!uwcom_existsCheck(dataChannelPtr, 'DataChannelRegisterOnOpen', 'dataChannel')) return;
    uwevt_DCOnOpen = DataChannelNativeOnOpen;
  },
    
  DataChannelRegisterOnClose: function (contextPtr, dataChannelPtr, DataChannelNativeOnClose) {
